...
public class EnemyManager : MonoBehaviour {
    ...
    public Transform[] boar_SpawnPoints, cannibal_SpawnPoints;

    [SerializeField]
    private int boar_Enemy_Count, cannibal_Enemy_Count;

    private int initial_Boar_Count, initial_Cannibal_Count;
